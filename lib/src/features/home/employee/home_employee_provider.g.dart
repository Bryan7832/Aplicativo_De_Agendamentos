...
class GetTotalSchedulesTodayFamily extends Family<AsyncValue<int>> {
  ...
  /// See also [getTotalSchedulesToday].
  GetTotalSchedulesTodayProvider call(int userId) {
    return GetTotalSchedulesTodayProvider(userId);
  }
...
class GetTotalSchedulesTodayProvider extends AutoDisposeFutureProvider<int> {
  /// See also [getTotalSchedulesToday].
  GetTotalSchedulesTodayProvider(int userId)
    : this._internal(
        (ref) =>
            getTotalSchedulesToday(ref as GetTotalSchedulesTodayRef, userId),
